...
- **Vanilla JavaScript:** Scripts puros e leves injetados diretamente no documento para gerenciar o estado da aplicação instantaneamente (prevenindo *FOUC - Flash of Unstyled Content*).
